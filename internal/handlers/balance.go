...
func GetBalanceHandler(balanceService *service.BalanceService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		current, withdrawn, err := balanceService.GetBalance(c.Request.Context(), userID.(int64))
		if err != nil {
